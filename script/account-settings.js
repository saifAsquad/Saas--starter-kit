...
function emailInteracton(e) {
	document.getElementById("change-email").classList.toggle("hidden");
	e.parentElement.classList.add("hidden");
}

function hideInteraction() {
	document.getElementById("change-email").classList.toggle("hidden");
	document.getElementById("email-button").classList.toggle("hidden");
}

const passwordInteraction = (e) => {
	e.parentElement.classList.toggle("hidden");
	document.getElementById("password-interaction").classList.toggle("hidden");
};

const hidePasswordInteraction = () => {
	document.getElementById("password-interaction").classList.toggle("hidden");
	document.getElementById("password-button").classList.toggle("hidden");
};
